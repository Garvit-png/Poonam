...
const MoltenMetal: React.FC<MoltenMetalProps> = ({
  ...
  useEffect(() => {
    ...
    const [c1, c2, c3, bg] = [hexToRgb(color1), hexToRgb(color2), hexToRgb(color3), hexToRgb(backgroundColor)];
    (u.uColor1.value as Float32Array).set(c1);
    (u.uColor2.value as Float32Array).set(c2);
    (u.uColor3.value as Float32Array).set(c3);
    (u.uBackgroundColor.value as Float32Array).set(bg);
      ...
      mouseStrength, opacity, backgroundColor, lightMode]);
